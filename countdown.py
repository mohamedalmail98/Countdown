...
st.markdown("""
    ...
    body::before {
        ...
        background-image: url('https://images.pexels.com/photos/27101596/pexels-photo-27101596.jpeg');
...
st.markdown("<h1 style='text-align: center; font-size: 36px;'> ‧₊˚ ☁️⋅♡🪐༘⋆⌛ Countdown till you come back ⌛‧₊˚ ☁️⋅♡🪐༘⋆</h1>", unsafe_allow_html=True)
st.markdown("---")
