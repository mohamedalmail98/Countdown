...
st.markdown("""
    ...
    h1, h2, h3, h4, h5, h6, p, div, span, label, .css-1d391kg, .css-ffhzg2 {
        color: white !important;
    }
    .fact {
        text-align: center;
...
# --- Astronomy Facts by Time Remaining ---
fact_categories = {
    "21_30": [
...
current_fact = get_fact_for_remaining_time((target_date - datetime.now()).days)
...
while True:
    ...
    percent_complete = min(100, (elapsed_seconds / total_duration) * 100)
