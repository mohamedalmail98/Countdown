...
st.markdown("""
    ...
    body::before {
        ...
        background-image: url('https://images.unsplash.com/photo-1475274047050-1d0c0975c63e?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8c3BhY2UlMjBiYWNrZ3JvdW5kfGVufDB8fDB8fHww');
